server <- function(input, output, session) {
  ...
  observeEvent(input$disease, {
    ...
    withProgress(message = paste("Reading peptide database of", input$disease), value = 0, {
      ...
      incProgress(0.2, detail = "Initializing database connection...")
      ...
      incProgress(0.6, detail = "Loading database...")
      
      incProgress(1, detail = "Peptide database loaded successfully.")
    })
    
    showNotification(
      paste("The data for", input$disease, "is successfully loaded and ready for filtering."),
      type = "message",
      duration = 5
    )
  ...
  filteredData <- reactive({
    ...
    withProgress(message = 'Processing...', value = 0, {
      ...
      incProgress(0.7, detail = "Rendering data...")
